...
public class TripExpendituresAdapter extends RecyclerView.Adapter<TripExpendituresAdapter.MyViewHolder> {

    private Context context;
    private List<GroupExpendituresItem> groupExpendituresItems;


    public TripExpendituresAdapter(Context context, List<GroupExpendituresItem> groupExpendituresItems) {
